...
function processStyleArg(callableStyle, _ref) {
  let {
    ownerState
  } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded30);
...
var ThemeContext2 = React78.createContext(null);
if (true) {
...
function useTheme() {
  const theme = React79.useContext(ThemeContext_default);
  if (true) {
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React83.useCallback((mode) => {
  ...
  const setColorScheme = React83.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React83.useCallback((e) => {
  ...
  const mediaListener = React83.useRef(handleMediaQuery);
...
var _excluded31 = ["colorSchemes", "components", "generateCssVars", "cssVarPrefix"];
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React84.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => {
    const value = React84.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider({
    ...
    const hasMounted = React84.useRef(false);
    const upperTheme = useTheme();
    const ctx = React84.useContext(ColorSchemeContext);
    ...
    const _ref = scopedTheme || themeProp, {
      ...
      cssVarPrefix
    } = _ref, restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded31);
    ...
    const element = (0, import_jsx_runtime55.jsxs)(React84.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime55.jsxs)(React84.Fragment, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    disableNestedContext: import_prop_types35.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types35.default.bool,
    /**
...
init_objectWithoutPropertiesLoose();
init_deepmerge();
var _excluded33 = ["colorSchemes", "components", "defaultColorScheme"];
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React86.createContext(void 0);
  if (true) {
    GridOverflowContext.displayName = "GridOverflowContext";
  }
  const useUtilityClasses28 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing,
  ...
  const Grid2 = React86.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React86.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    const classes = useUtilityClasses28(ownerState, theme);
    let result = (0, import_jsx_runtime57.jsx)(GridRoot, _extends({
      ...
      children: React86.Children.map(children2, (child) => {
        if (React86.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime57.jsx)(GridOverflowContext.Provider, {
...
function joinChildren(children2, separator) {
  const childrenArray = React87.Children.toArray(children2).filter(Boolean);
...
init_objectWithoutPropertiesLoose();
init_useForkRef();
var _excluded37 = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"];
var _excluded211 = ["component", "slots", "slotProps"];
var _excluded38 = ["component"];
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded37);
  const {
  ...
  } = externalForwardedProps, other = _objectWithoutPropertiesLoose(externalForwardedProps, _excluded211);
  ...
  const _mergeSlotProps = mergeSlotProps(_extends({
    ...
    internalRef
  } = _mergeSlotProps, mergedProps = _objectWithoutPropertiesLoose(_mergeSlotProps.props, _excluded38);
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React96.useState(false);
...
var TouchRipple = React97.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React97.useState([]);
  const nextKey = React97.useRef(0);
  const rippleCallback = React97.useRef(null);
  React97.useEffect(() => {
  ...
  const ignoringMouseDown = React97.useRef(false);
  const startTimer = useTimeout();
  const startTimerCommit = React97.useRef(null);
  const container = React97.useRef(null);
  const startCommit = React97.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime61.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start2 = React97.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React97.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React97.useCallback((event, cb) => {
    startTimer.clear();
  ...
  return (0, import_jsx_runtime61.jsx)(TouchRippleRoot, _extends({
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime61.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React98.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React98.useRef(null);
  ...
  const [mountedState, setMountedState] = React98.useState(false);
  React98.useEffect(() => {
    setMountedState(true);
  }, []);
  ...
  const keydownRef = React98.useRef(false);
  ...
  return (0, import_jsx_runtime63.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime62.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var IconButton = React99.forwardRef(function IconButton2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  return (0, import_jsx_runtime64.jsx)(IconButtonRoot, _extends({
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types52.default.node, (props) => {
    const found = React99.Children.toArray(props.children).some((child) => React99.isValidElement(child) && child.props.onClick);
    if (found) {
   ...
   * @default 'default'
   */
  color: import_prop_types52.default.oneOfType([import_prop_types52.default.oneOf(["inherit", "default", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types52.default.string]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
...
var SuccessOutlined_default = createSvgIcon((0, import_jsx_runtime65.jsx)("path", {
...
var ReportProblemOutlined_default = createSvgIcon((0, import_jsx_runtime66.jsx)("path", {
...
var ErrorOutline_default = createSvgIcon((0, import_jsx_runtime67.jsx)("path", {
...
var InfoOutlined_default = createSvgIcon((0, import_jsx_runtime68.jsx)("path", {
...
var defaultIconMapping = {
  success: (0, import_jsx_runtime70.jsx)(SuccessOutlined_default, {
    fontSize: "inherit"
  }),
  warning: (0, import_jsx_runtime70.jsx)(ReportProblemOutlined_default, {
    fontSize: "inherit"
  }),
  error: (0, import_jsx_runtime70.jsx)(ErrorOutline_default, {
    fontSize: "inherit"
  }),
  info: (0, import_jsx_runtime70.jsx)(InfoOutlined_default, {
    fontSize: "inherit"
  })
};
var Alert = React105.forwardRef(function Alert2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiAlert"
  });
  ...
  return (0, import_jsx_runtime71.jsxs)(AlertRoot, _extends({
    role,
    elevation: 0,
    ownerState,
    className: clsx_default(classes.root, className),
    ...
    children: [icon !== false ? (0, import_jsx_runtime70.jsx)(AlertIcon, {
      ownerState,
      className: classes.icon,
      children: icon || iconMapping[severity] || defaultIconMapping[severity]
    }) : null, (0, import_jsx_runtime70.jsx)(AlertMessage, {
      ownerState,
      className: classes.message,
      children: children2
    }), action != null ? (0, import_jsx_runtime70.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
      children: action
    }) : null, action == null && onClose ? (0, import_jsx_runtime70.jsx)(AlertAction, {
      ownerState,
      className: classes.action,
      children: (0, import_jsx_runtime70.jsx)(CloseButtonSlot, _extends({
        size: "small",
        ...
        children: (0, import_jsx_runtime70.jsx)(CloseIconSlot, _extends({
          fontSize: "small"
        }, closeIconProps))
      }))
    }) : null]
...
true ? Alert.propTypes = {
   ...
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   */
  color: import_prop_types53.default.oneOfType([import_prop_types53.default.oneOf(["error", "info", "success", "warning"]), import_prop_types53.default.string]),
  /**
  ...
  components: import_prop_types53.default.shape({
    CloseButton: import_prop_types53.default.elementType,
    CloseIcon: import_prop_types53.default.elementType
  }),
  /**
  ...
  componentsProps: import_prop_types53.default.shape({
    closeButton: import_prop_types53.default.object,
    closeIcon: import_prop_types53.default.object
  }),
  /**
   ...
   */
  iconMapping: import_prop_types53.default.shape({
    error: import_prop_types53.default.node,
    info: import_prop_types53.default.node,
    success: import_prop_types53.default.node,
    warning: import_prop_types53.default.node
  }),
  /**
   * Callback fired when the component requests to be closed.
   ...
   * @default 'success'
   */
  severity: import_prop_types53.default.oneOfType([import_prop_types53.default.oneOf(["error", "info", "success", "warning"]), import_prop_types53.default.string]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types53.default.shape({
    closeButton: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.object]),
    closeIcon: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YAWJ7UZZ.js.map
